import { SvgProps } from "@/src/util/types"
...
export function WhatsappIcon({ fill, width, height }: SvgProps) {
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={fill ?? "#25D366"}>
