  ...
  const pictures = [
    {
      pic1:
        <div className="w-full flex relative">
          ...
          <span className="text-white absolute top-0 w-1/2 right-0 h-full px-3 py-6 sm:p-14 lg:p-28 sm:pt-24" style={{ backgroundColor: "rgba(115, 86, 61, 0.6)" }}>
      ...
      pic2:
        <div className="w-full flex relative">
          ...
          <span className="text-white absolute top-0 w-1/2 right-0 h-full px-3 py-6 sm:p-14 sm:pt-24 lg:p-28" style={{ backgroundColor: "rgba(115, 86, 61, 0.6)" }}>
            <h3 className="text-sm sm:text-lg lg:text-4xl xl:text-5xl mb-4 lg:mt-24">
              SALADA ATENIENSE
            </h3>
            <p className="text-xs sm:text-base lg:text-2xl xl:text-3xl">
  ...
  return (
    <>
      ...
      <div className="w-full overflow-x-hidden">
        ...
        <div className="w-full flex bg-primary text-white flex-col items-center mt-4 md:mt-12 md:text-xl lg:text-2xl xl:text-[40px]" id="cardapio">
        ...
        <div className="w-full flex flex-col items-center justify-center px-16 py-8 md:py-8 xl:py-32 text-primary" id="social-media">
        ...
        <div className="w-full flex flex-col md:pl-16 md:h-96 xl:h-[580px] md:relative bg-primary text-white justify-center items-center md:items-start md:justify-normal pt-4 xl:pt-10 2xl:pt-16 md:gap-y-3" id="location">
        ...
        <div id="contato" className="w-full flex flex-col sm:flex-row relative py-4 lg:p-0 bg-white text-primary md:justify-center">
          <Image src={SaladaLeonidas} alt="Prato de saladas Leonidas" className="w-full hidden lg:flex opacity-60 h-[760px]" />
          <h1 className="hidden md:flex text-4xl xl:text-5xl absolute xl:mt-8 drop-shadow-[0_1px_1px_rgba(0,0,0,8)] lg:text-white">ENTRE EM CONTATO</h1>
          <div className="w-full lg:absolute lg:flex md:gap-x-12 xl:gap-x-24">
            <form className="w-full flex flex-col justify-center items-center gap-y-2 px-4 pb-8 pt-2 md:mt-16 xl:mt-32 xl:pl-72 md:relative">
              ...
              <button className="bg-primary text-white p-2 md:absolute -bottom-6 left-32 xl:left-72 border xl:text-xl transition-all duration-300 ease-in-out hover:bg-white hover:text-primary hover:border hover:border-primary">ENVIAR FORMULÁRIO</button>
            </form>
        ...
        <footer className="w-full flex items-center justify-center py-2 bg-primary text-white md:mt-8 lg:m-0 md:py-4 xl:text-lg">
