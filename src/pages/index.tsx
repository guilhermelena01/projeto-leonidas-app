  ...
  return (
    <>
      ...
      <div className="w-full overflow-x-hidden">
        ...
        <div className="w-full font-via-appia text-primary px-8 lg:px-16 xl:px-48 2xl:px-72 xl:py-32">
        ...
        <div className="w-full flex flex-col sm:flex-row relative py-4 lg:p-0 bg-white font-via-appia text-primary md:justify-center">
          ...
          <h1 className="hidden md:flex text-4xl xl:text-6xl absolute xl:mt-8 drop-shadow-[0_1px_1px_rgba(0,0,0,8)]">ENTRE EM CONTATO</h1>
          <div className="w-full lg:absolute lg:flex md:gap-x-12 xl:gap-x-24">
            <form className="w-full flex flex-col justify-center items-center gap-y-2 px-4 pb-8 pt-2 md:mt-16 xl:mt-32 md:pl-32 xl:pl-72 md:relative">
            ...
            <div className="w-full flex flex-col items-center justify-center text-primary md:flex-row md:mt-16 xl:mt-32 md:justify-normal md:items-start">
