...
export default function Home() {
  ...
  return (
    <>
      ...
      <div style={{ width: "100%" }} className="font-via-appia text-primary px-8 lg:px-16 xl:px-48 2xl:px-72 xl:py-32">
      ...
      <div className="w-full flex flex-col sm:flex-row relative py-4 bg-primary md:bg-white font-via-appia text-white md:justify-center md:gap-x-12 xl:gap-x-24">
        ...
        <div className="w-full flex flex-col items-center justify-center text-white md:text-primary md:flex-row md:mt-16 xl:mt-32 md:justify-normal md:items-start">
          <div className="flex md:flex-col gap-x-4">
            ...
            <ul>
              <h2 className="text-lg md:text-xl xl:text-3xl mb-2">Horário de atendimento</h2>
              <li className="xl:text-xl">Terça a Sexta: 19h às 23h</li>
              <li className="xl:text-xl">Sábados e feriados: 14h às 18h</li>
              <li className="xl:text-xl">Domingos: 15h às 18h</li>
            </ul>

            <ul>
              <h2 className="text-lg md:text-xl xl:text-3xl mb-2 md:mt-8">Nossas mídias sociais</h2>
              <li className="flex gap-x-2 md:items-center md:text-lg md:gap-x-1 xl:text-xl">
